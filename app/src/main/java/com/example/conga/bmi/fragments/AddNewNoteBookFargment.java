...
public class AddNewNoteBookFargment extends BaseFragment {
...
//        });
    ...
    private void saveData() {
        ...
        NoteBook noteBook = new NoteBook(subject, content, date);
        try {
            mNoteBookDatabaseHelper.addNewNoteBook(noteBook);
