...
public class ChuongTrinhLuyenTapBMIFrag extends BaseFragment {
    public static final  String ITEM_NAME ="iTem" ;
    private static String TAG = ChuongTrinhLuyenTapBMIFrag.class.getSimpleName();
    ...
    protected int setLayoutById() {
        return R.layout.chuongtrinhluyentapweightfrag;
    }
